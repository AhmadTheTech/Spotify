...
class DarkRegisterPage extends StatefulWidget {
  const DarkRegisterPage({super.key});

  @override
  State<DarkRegisterPage> createState() => _DarkRegisterPageState();
}

class _DarkRegisterPageState extends State<DarkRegisterPage> {
  @override
